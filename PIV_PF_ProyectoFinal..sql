...
-- Insertar usuarios
INSERT INTO [SCH_FARMACIA_PROGRA4].[T_USUARIOS] (ID_USUARIO, IDENTIFICACION, NOMBRE, APELLIDO, CORREO, CLAVE, ESTADO, ID_ROLE) VALUES
(1, '1111', 'pablo', 'camacho', 'fake@email.com', 'admin','ACTIVO', 1),
(2, '2222', 'mike', 'VendedorApellido', 'vendedor@example.com', 'claveVendedor','ACTIVO', 2),
(3, '333', 'jean', 'ContadorApellido', 'contador@example.com', 'claveContador','ACTIVO', 3);
...
(1, 'paracetamol', 'Analgésico y antipirético', 7000, 1, 100, 1),
(2, 'champú Anticaspa', 'Elimina la caspa y alivia la picazón', 18000, 1, 50, 2),
(3, 'vitamina C', 'Suplemento de vitamina C', 585, 1, 75, 3);

-- Insertar clientes
INSERT INTO [SCH_FARMACIA_PROGRA4].[T_CLIENTES] (ID_CLIENTE, IDENTIFICACION, NOMBRE_CLIENTE, APELLIDO, CORREO, ESTADO) VALUES
(1, 'C001', 'Cliente1', 'ApellidoCliente1', 'cliente1@example.com', 'ACTIVO'),
(2, 'C002', 'Cliente2', 'ApellidoCliente2', 'cliente2@example.com', 'INACTIVO');

-- Insertar facturas
INSERT INTO [SCH_FARMACIA_PROGRA4].[T_FACTURAS] (ID_FACTURA, FECHA_COMPRA, MONTO_TOTAL, ESTADOACTIVO, ID_CLIENTE, ID_USUARIO, ID_PRODUCTO) VALUES
(3, '2023-11-01', 24.47, 1, 1, 2, 1),
(4, '2023-11-02', 17.98, 1, 2, 1, 3);
